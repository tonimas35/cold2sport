    ...
    <section id="team" className="bg-white py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-16 text-center">
          <p className="mb-3 font-body text-[11px] font-medium tracking-[0.1em] text-brand-blue">Our team</p>
          ...
          {team.map((member) => (
            <motion.div key={member.name} variants={fadeUp} className="text-center">
              <Image
                ...
                width={88}
                height={88}
                className="mx-auto h-[88px] w-[88px] rounded-full object-cover outline outline-2 outline-offset-[3px] outline-brand-blue"
              />
              ...
              <a
                ...
                className="mt-4 inline-block text-brand-blue transition-colors hover:text-brand-blue/70"
