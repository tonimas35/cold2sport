...
const benefits = [
  ...
  {
    title: 'Stability',
    description: 'High levels of stability and thermal autonomy, to enjoy the ideal temperature for as long as necessary.',
    image: '/cold2sport/images/cold2sport-nautic23-Baja-1-800x694.jpg',
  },
  {
    title: 'Health',
    description: 'Products designed to improve the well-being and health of sportsmen and women. Anti-inflammatory benefits.',
    image: '/cold2sport/images/cold2sport-Carolina-Cambrils-baja-16.jpg',
  },
  {
    title: 'Sustainability',
    description: 'We replace ice in the world of sport, improving water consumption management in sports clubs.',
    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="container-wide">
        <AnimatedSection className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-heading font-light text-brand-navy tracking-tighter">
            Key Benefits of
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {benefits.map((b, i) => (
            <AnimatedSection key={b.title} delay={i * 0.08}>
              <div className="group relative aspect-[3/4] rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300">
