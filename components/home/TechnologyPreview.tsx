      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-16 px-6 lg:flex-row lg:gap-20 lg:px-8">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-10">
            {stats.map((s) => (
              <div key={s.label}>
                <p className="font-heading text-[52px] font-light text-brand-gold">{s.value}</p>
          ...
          <div className="mt-10">
            <a
              href="/#technology"
              className="rounded-full border border-brand-gold/40 px-7 py-3 text-[14px] font-medium text-brand-gold transition-all duration-300 hover:bg-brand-gold/10"
            >
        ...
        >
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-10">
            ...
            <svg viewBox="0 0 400 220" className="w-full" role="img" aria-label="BioFresh Tech thermal phase diagram showing three cooling phases">
              ...
              <rect x="155" y="35" width="115" height="135" rx="4" fill="rgba(205,162,116,0.12)" stroke="rgba(205,162,116,0.4)" strokeWidth="1" />
              ...
              <text x="212" y="105" textAnchor="middle" fill="#cda274" fontSize="10" fontWeight="600">Phase Change</text>
              <text x="212" y="122" textAnchor="middle" fill="rgba(205,162,116,0.5)" fontSize="8">BioFresh Window</text>
              ...
              <line x1="155" y1="85" x2="270" y2="85" stroke="#cda274" strokeWidth="1.5" strokeDasharray="4 3" opacity="0.6" />
              <circle cx="155" cy="85" r="3.5" fill="#cda274" />
              <circle cx="270" cy="85" r="3.5" fill="#cda274" />
              <text x="148" y="78" textAnchor="end" fill="#cda274" fontSize="9" fontWeight="500">10°C</text>
              <text x="278" y="78" fill="#cda274" fontSize="9" fontWeight="500">15°C</text>
            </svg>
          </div>
        </motion.div>
      </div>
