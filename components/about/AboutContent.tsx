  ...
  return (
    <>
      ...
      <section className="bg-brand-navy pt-36 pb-24">
        ...
        >
          <p className="mb-4 font-body text-[11px] font-medium tracking-[0.1em] text-brand-blue">Our story</p>
      ...
      <section className="bg-brand-offwhite py-24">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <div className="relative">
            <div className="absolute left-5 top-0 h-full w-px bg-brand-blue/30 md:left-1/2" />
            <div className="space-y-10">
              {milestones.map((m, i) => (
                ...
                >
                  <div className="absolute left-5 top-1.5 h-3 w-3 -translate-x-1/2 rounded-full bg-brand-blue md:left-1/2" />
                  <div className={`ml-12 md:ml-0 md:w-[44%] ${i % 2 === 0 ? 'md:text-right md:pr-10' : 'md:text-left md:pl-10'}`}>
                    <p className="font-heading text-[14px] font-semibold text-brand-blue">{m.period}</p>
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap gap-10">
              {[
                ...
                <div key={stat.label}>
                  <p className="font-heading text-[52px] font-light text-brand-blue">{stat.value}</p>
          ...
          >
            <div className="flex items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.03] p-14">
              <svg viewBox="0 0 200 200" className="h-56 w-56" role="img" aria-label="BioFresh Tech PCM microcapsule structure">
                ...
                <circle cx="100" cy="100" r="28" fill="rgba(0,155,219,0.06)" stroke="#009bdb" strokeWidth="1.5" opacity="0.6" />
                <circle cx="100" cy="100" r="10" fill="rgba(0,155,219,0.3)" />
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-16 text-center">
            <p className="mb-3 font-body text-[11px] font-medium tracking-[0.1em] text-brand-blue">Our values</p>
      ...
      <section className="bg-brand-offwhite py-24">
        <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-3">
            <div className="rounded-2xl border border-brand-border bg-brand-offwhite p-6">
              <p className="font-body text-[11px] font-medium tracking-[0.1em] text-brand-text-light">Email</p>
              <a href="mailto:info@cold2sport.com" className="mt-2 block font-body text-[14px] text-brand-navy hover:text-brand-blue">info@cold2sport.com</a>
            </div>
            <div className="rounded-2xl border border-brand-border bg-brand-offwhite p-6">
            ...
            <div className="rounded-2xl border border-brand-border bg-brand-offwhite p-6">
              ...
              <div className="mt-2 flex justify-center gap-4">
                <a href="https://instagram.com/cold2.sport" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-brand-text-mid hover:text-brand-blue">
                ...
                <a href="https://linkedin.com/company/cold2sport" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-brand-text-mid hover:text-brand-blue">
